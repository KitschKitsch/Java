...
<body>
	...
	<section>
		...
		<table>
			<tr>
				<th><strong>제 목</strong> <span class="separator">|</span>
					${board.btitle }</th>
			</tr>
			<tr>
				<td><strong>작성자</strong> <span class="separator">|</span>${board.id}</td>
			</tr>
			<tr>
				<td><strong>날 짜</strong> <span class="separator">|</span>${board.bdate}</td>
			</tr>
			<tr>
				<td><strong>조회수</strong> <span class="separator">|</span>${board.bhit}</td>
			</tr>
			<tr>
				<td class="article">${board.bcontent}<br></td>
			</tr>
			...
			<tr>
				<td><strong>다음글</strong> <span class="separator">|</span> [키즈잼]
					2월 프로그램 안내</td>
			</tr>
			<tr>
				<td><strong>이전글</strong> <span class="separator">|</span> [키즈잼]
					2020년 1분기 정기 휴관일 안내</td>
			</tr>
		</table>
		...
		<div class="list">
			<a href="delete.do?bno=${board.bno}">삭제</a>
		</div>
		<div class="list">
			<a href="edit.do?bno=${board.bno}">수정</a>
		</div>
	</section>
